...
const fs = require('fs');
const baseUrl = process.env.BASE_URL + '/v1/methodology_master';
const token = process.env.USER_TOKEN;

describe('Methodology Master API', () => {
  ...
  it('Bulk Upload', async () => {
    ...
    const filePath = './SampleBulkUploadFile/sample_methodology_master.xlsx'; // Replace with your file path
