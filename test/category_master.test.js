...
const fs = require('fs');
const baseUrl = process.env.BASE_URL + '/v1/category_master';
const token = process.env.USER_TOKEN;

describe('Category Master API', () => {
  ...
  it('Bulk Upload', async () => {
    ...
    const filePath = './SampleBulkUploadFile/sample_category_master.xlsx'; // Replace with your file path
