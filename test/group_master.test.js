...
const fs = require('fs');
const baseUrl = process.env.BASE_URL + '/v1/group_master';
const token = process.env.USER_TOKEN;

describe('Group Master API', () => {
  ...
  it('Bulk Upload', async () => {
    ...
    const filePath = './SampleBulkUploadFile/sample_group_master.xlsx'; // Replace with your file path
