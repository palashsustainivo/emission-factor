...
const fs = require('fs');
const baseUrl = process.env.BASE_URL + '/v1/calculation_methodology_master';
const token = process.env.USER_TOKEN;

describe('Calculation Methodology Master API', () => {
  ...
  it('Create Reccord', async () => {
    let bodyData = {
      calculation_methodology_name:"Test 4",
      gwp_value:"Test 2",
      gwp_value_for_co2:"Test 2",
      gwp_value_for_ch4:"Test 2",
      gwp_value_for_n2o:"Test 2"
    };
  ...
  it('Update Single Reccord', async () => {
    let bodyData = {
      calculation_methodology_name:"Test 4444",
      gwp_value:"Test 2222",
      gwp_value_for_co2:"Test 2222",
      gwp_value_for_ch4:"Test 2222",
      gwp_value_for_n2o:"Test 2222"
    };
  ...
  it('Bulk Upload', async () => {
    ...
    const filePath = './SampleBulkUploadFile/sample_calculation_methodology_master.xlsx'; // Replace with your file path
