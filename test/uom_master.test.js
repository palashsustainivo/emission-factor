...
const fs = require('fs');
const baseUrl = process.env.BASE_URL + '/v1/uom_master';
const token = process.env.USER_TOKEN;

describe('UOM Master API', () => {
  ...
  it('Bulk Upload', async () => {
    ...
    const filePath = './SampleBulkUploadFile/sample_uom_master.xlsx'; // Replace with your file path
