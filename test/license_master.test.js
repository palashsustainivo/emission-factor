...
const fs = require('fs');
const baseUrl = process.env.BASE_URL + '/v1/license_master';
const token = process.env.USER_TOKEN;

describe('License Master API', () => {
  ...
  it('Bulk Upload', async () => {
    ...
    const filePath = './SampleBulkUploadFile/sample_license_master.xlsx'; // Replace with your file path
