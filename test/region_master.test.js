...
const fs = require('fs');
const baseUrl = process.env.BASE_URL + '/v1/region_master';
const token = process.env.USER_TOKEN;

describe('Region Master API', () => {
  ...
  it('Bulk Upload', async () => {
    ...
    const filePath = './SampleBulkUploadFile/sample_region_master.xlsx'; // Replace with your file path
