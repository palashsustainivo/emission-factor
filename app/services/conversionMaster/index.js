...
import dbCrud from '../../models/conversionMaster/index.js';
import modelDbCrud from './dbCrud.js';
import sectorModelDbCrud from '../../models/uomMaster/index.js';
import readExcel from '../../common/readExcel.js';
const { Op } = require('sequelize');
const log = require('node-file-logger');
import sanitizeHtml from 'sanitize-html';
const primaryKey = "conversion_id";

/**
 * Get all conversion master records
...
/**
 * Get a single conversion master record by ID
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Create a new conversion master record
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Create multiple conversion master records while bulk uploading
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
  ...
  try {
    ...
    if(dbStoreData) {
      ...
      for(let item of dbStoreData) {
        ...
        let returnQueryData = await sectorModelDbCrud.findOneReccord({sector_name: item.sector_name, is_deleted: process.env.IS_DELETED_NO});
        if(returnQueryData != null){
          modifiedRow++;
          rowItem.sector_id = returnQueryData.sector_id;
...
/**
 * Update a conversion master record by ID
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Delete a conversion master record by ID
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Delete multiple conversion master record by ID Array
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Soft Delete multiple conversion master record by ID Array
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
