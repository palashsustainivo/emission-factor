...
import dbCrud from '../../models/sourceMaster/index';
import readExcel from '../../common/readExcel';
import { Op } from 'sequelize';
const log = require('node-file-logger');
import sanitizeHtml from 'sanitize-html';
const primaryKey = "source_id";

/**
 * Get all source master records
...
/**
 * Get a single source master record by ID
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Create a new source master record
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Create multiple source master records while bulk uploading
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Update a source master record by ID
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Delete a source master record by ID
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Delete multiple source master record by ID Array
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Soft Delete multiple source master record by ID Array
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
