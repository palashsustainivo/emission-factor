...
import dbCrud from '../../models/licenseTypeMaster/index';
import readExcel from '../../common/readExcel';
import { Op } from 'sequelize';
const log = require('node-file-logger');
import sanitizeHtml from 'sanitize-html';
const primaryKey = "license_type_id";

/**
 * Get all license type master records
...
/**
 * Get a single license type master record by ID
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Create a new license type master record
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Create multiple license type master records while bulk uploading
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Update a license type master record by ID
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Delete a license type master record by ID
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Delete multiple license type master record by ID Array
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Soft Delete multiple license type master record by ID Array
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
