...
import dbCrud from '../../models/sectorMaster/index.js';
...
const primaryKey = "sector_id";

/**
 * Get all sector master records
...
/**
 * Get a single sector master record by ID
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Create a new sector master record
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Create multiple sector master records while bulk uploading
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
  ...
  try {
    ...
    if(dbStoreData) {
      ...
      for(let item of dbStoreData) {
        ...
        let returnQueryData = await groupModelDbCrud.findOneReccord({group_name: item.group_name, is_deleted: process.env.IS_DELETED_NO});
        if(returnQueryData != null){
          modifiedRow++;
          rowItem.group_id = returnQueryData.group_id;
          modifiedData.push(rowItem);
        } else {
          let insertData = await groupModelDbCrud.create({group_name: item.group_name, created_by: item.created_by});
          let pushData = {
...
/**
 * Update a sector master record by ID
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Delete a sector master record by ID
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Delete multiple sector master record by ID Array
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Soft Delete multiple sector master record by ID Array
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
