...
import dbCrud from '../../models/verificationTypeMaster/index';
import readExcel from '../../common/readExcel';
import { Op } from 'sequelize';
const log = require('node-file-logger');
import sanitizeHtml from 'sanitize-html';
const primaryKey = "verification_type_id";

/**
 * Get all verification type master records
...
/**
 * Get a single verification type master record by ID
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Create a new verification type master record
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Create multiple verification type master records while bulk uploading
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Update a verification type master record by ID
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Delete a verification type master record by ID
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Delete multiple verification type master record by ID Array
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Soft Delete multiple verification type master record by ID Array
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
