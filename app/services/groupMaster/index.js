...
import dbCrud from '../../models/groupMaster/index';
...
/**
 * Get a single group master record by ID
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Create multiple group master records while bulk uploading
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Update a group master record by ID
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Delete multiple group master record by ID Array
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
...
/**
 * Soft Delete multiple group master record by ID Array
 * @param {Request} req - Express request object
 * @param {Response} res - Express response object
 */
